...
namespace alterhook
{
  ...
  {
    constexpr PUSH(reg_t reg) : ARM_INSTRUCTION({ 0xE5'2D'00'04 | (reg << 12) })
    {
    }
  };
  ...
  {
    constexpr PUSH_REGLIST() : ARM_INSTRUCTION({ 0xE9'2D'00'00 }) {}
  ...
  {
    constexpr POP(reg_t reg) : ARM_INSTRUCTION({ 0xE4'9D'00'04 | (reg << 12) })
    {
    }
  };
  ...
  struct MOV : ARM_INSTRUCTION
  {
    constexpr MOV(reg_t dest, reg_t src)
        : ARM_INSTRUCTION({ 0xE1'A0'00'00 | (dest << 12) | src })
    {
    }
  ...
  struct ADD : ARM_INSTRUCTION
  {
    constexpr ADD(reg_t dstreg, reg_t operandreg, uint16_t offset)
        : ARM_INSTRUCTION(
              { 0xE2'80'00'00 | (operandreg << 16) | (dstreg << 12) | offset })
    {
    }
    ...
    constexpr void set_destination_register(reg_t reg)
    {
      ARM_INSTRUCTION::set_register(reg);
    }
  ...
  {
    constexpr THUMB2_PUSH_REGLIST() : THUMB2_INSTRUCTION({ 0xE9'2D, 0x00'00 })
    {
    }
  ...
  {
    constexpr THUMB2_LDR_LITERAL(reg_t reg, int32_t offset)
        : THUMB2_LDR_LITERAL_LIKE({ 0xF8'5F, static_cast<uint16_t>(reg << 12) })
    {
      set_offset(offset);
    }
  };
  ...
  {
    constexpr THUMB2_LDRH_LITERAL(reg_t reg, int32_t offset)
        : THUMB2_LDR_LITERAL_LIKE({ 0xF8'3F, static_cast<uint16_t>(reg << 12) })
    {
      set_offset(offset);
    }
  };
  ...
  {
    constexpr THUMB2_LDRB_LITERAL(reg_t reg, int32_t offset)
        : THUMB2_LDR_LITERAL_LIKE({ 0xF8'1F, static_cast<uint16_t>(reg << 12) })
    {
      set_offset(offset);
    }
  };
  ...
  struct THUMB2_LDR_IMM : THUMB2_INSTRUCTION
  {
    constexpr THUMB2_LDR_IMM(reg_t destreg, reg_t operandreg, uint16_t offset)
        : THUMB2_INSTRUCTION(
              { static_cast<uint16_t>(0xF8'D0 | operandreg),
    ...
    constexpr void set_destination_register(reg_t reg)
    {
      THUMB2_INSTRUCTION::set_register(reg);
    }
  ...
  struct THUMB2_ADD : THUMB2_INSTRUCTION
  {
    constexpr THUMB2_ADD(reg_t destreg, reg_t operandreg, uint16_t offset)
        : THUMB2_INSTRUCTION({ static_cast<uint16_t>(0xF2'00 | operandreg),
  ...
  struct THUMB2_FULL_JMP_ABS
  {
    ...
    constexpr THUMB2_FULL_JMP_ABS(uint32_t address)
        : ldr(pc, 0), address(address)
    {
    }
  };
  ...
  {
    constexpr THUMB_PUSH(reg_t reg)
        : THUMB_INSTRUCTION({ static_cast<uint16_t>(0xB4'00 | (1 << reg)) })
    {
    }
  ...
  {
    constexpr THUMB_PUSH_REGLIST() : THUMB_INSTRUCTION({ 0xB4'00 }) {}
  ...
  {
    constexpr THUMB_POP(reg_t reg)
        : THUMB_INSTRUCTION({ static_cast<uint16_t>(0xBC'00 | (1 << reg)) })
    {
    }
  ...
  {
    constexpr THUMB_LDR_LITERAL(reg_t reg, uint8_t offset)
        : THUMB_INSTRUCTION(
  ...
  {
    constexpr THUMB_ADD(reg_t reg, uint8_t offset)
        : THUMB_INSTRUCTION(
  ...
  {
    constexpr NOP() : ARM_INSTRUCTION({ 0xE3'20'F0'00 }) {}
  };

  struct THUMB_NOP : private THUMB_INSTRUCTION
  {
    constexpr THUMB_NOP() : THUMB_INSTRUCTION({ 0xBF'00 }) {}
  };

  struct THUMB2_NOP : private THUMB2_INSTRUCTION
  {
    constexpr THUMB2_NOP() : THUMB2_INSTRUCTION({ 0xF3'AF, 0x80'00 }) {}
  };
  ...
  struct THUMB_IT : private THUMB_INSTRUCTION
  {
    ...
    constexpr THUMB_IT(CondCodes condition, it_cond scond = NONE,
                       it_cond tcond = NONE, it_cond fcond = NONE)
        : THUMB_INSTRUCTION(
              { static_cast<uint16_t>(0xBF'08 | (condition << 4)) })
    {
