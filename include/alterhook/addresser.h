#pragma once
  ...
  #define __alterhook_mustbememfuncptr_sfinae(type)                            \
    std::enable_if_t<utils::member_function_type<T>, type>
#endif
...
namespace alterhook
{
  ...
  public:
    ...
    static __alterhook_mustbememfuncptr_sfinae(bool) is_virtual(T memfuncptr)
    {
      return __alterhook_is_virtual(memfuncptr);
    }

    template <__alterhook_mustbememfuncptr T>
    static __alterhook_mustbememfuncptr_sfinae(uintptr_t)
        address_of(T memfuncptr)
    {
    ...
    template <__alterhook_mustbememfuncptr T>
    static __alterhook_mustbememfuncptr_sfinae(uintptr_t)
        address_of_virtual(T memfuncptr)
    {
    ...
    template <__alterhook_mustbememfuncptr T>
    static __alterhook_mustbememfuncptr_sfinae(uintptr_t)
        address_of_non_virtual(T memfuncptr)
    {
      return __alterhook_follow_thunk(
          *reinterpret_cast<uintptr_t*>(&memfuncptr));
    }
